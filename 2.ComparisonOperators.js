...
const insertData = async () => {
    var coll = await databaseConnect("comparisonCollection");
    var data = [
        {
            item: [10, 20, 30, 40],
        },
...
const comparisonOperators = async () => {
    ...
    var notEqualData = await coll.find({
        item:{
            $ne:40
        }
    }).toArray();
